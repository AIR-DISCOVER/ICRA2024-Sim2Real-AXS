...
|/airbot_play/joint_target|robotic arm| std_msgs/Header  <br>string[ ] name  <br>float64[ ] position  <br>float64[ ] velocity <br> float64[ ] effort | Set the Angle, speed and effort position of the robotic arm joint:  lists of Joint Angle，unit rad velocity: List of joint angular velocities，unit rad effort:   ？Joint limit: unknown|
